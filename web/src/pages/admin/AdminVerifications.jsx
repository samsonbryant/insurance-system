...
import { Shield, CheckCircle, XCircle, Clock, MapPin, Search } from 'lucide-react'
...
const AdminVerifications = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (row) => (
        row.officer
          ? `${row.officer.first_name || ''} ${row.officer.last_name || ''}`.trim() || row.officer.username
          : <span className="text-gray-400 italic">Public</span>
      ),
    },
  ]
